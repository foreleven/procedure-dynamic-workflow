...
4. Generate the workflow files.
   ...
   - For render LLM input, rely on the runtime-provided latest `state.messages` message log. Do not build a JSON render payload from state/context.
