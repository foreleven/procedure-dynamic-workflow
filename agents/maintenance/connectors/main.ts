...
/**
 * Provides the maintenance connector tools for engine-owned registry construction.
 * Input: none.
 ...
 */
export default function loadMaintenanceConnectorTools() {
  return maintenanceConnectorTools;
}
